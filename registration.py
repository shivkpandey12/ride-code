...
def insert():
    ...
    # to check mail, this is the standard mail format.
    #regex = '^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$'
...
l1 = tk.Label(window, text="Registration Form", font=("Times new roman", 30, "bold"), bg="#FF8040", fg="white")
l1.place(x=190, y=50)
...
btn = tk.Button(window, text="Register", bg="#FF8040",font=("",20),fg="white", width=9, height=1, command=insert)
